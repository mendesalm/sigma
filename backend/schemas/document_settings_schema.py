...
class DocumentTypeSettings(BaseModel):
    ...
    preamble_template: Optional[str] = Field(default=None, description="Template personalizado do preâmbulo (HTML/Jinja2)")
    signatures_template: Optional[str] = Field(default=None, description="Template personalizado das assinaturas (HTML/Jinja2)")
    date_place_template: Optional[str] = Field(default=None, description="Template personalizado de Data e Local (HTML/Jinja2)")
