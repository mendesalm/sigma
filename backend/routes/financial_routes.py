...
def create_new_financial_transaction(
    ...
    return financial_service.create_financial_transaction(db=db, transaction_data=transaction_data, current_user_payload=current_user_payload)
...
def get_financial_transaction(
    ...
    return financial_service.get_financial_transaction_by_id(db=db, transaction_id=transaction_id, current_user_payload=current_user_payload)
...
def update_existing_financial_transaction(
    ...
    return financial_service.update_financial_transaction(db=db, transaction_id=transaction_id, transaction_update=transaction_update, current_user_payload=current_user_payload)
...
def delete_existing_financial_transaction(
    ...
    financial_service.delete_financial_transaction(db=db, transaction_id=transaction_id, current_user_payload=current_user_payload)
