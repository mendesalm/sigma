...
def update_masonic_session(
    ...
    return session_service.update_session(db=db, session_id=session_id, session_update=session_update, current_user_payload=current_user_payload)
