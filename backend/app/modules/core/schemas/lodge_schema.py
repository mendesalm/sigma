...
class LodgeBase(BaseModel):
    ...
    available_modules: dict | None = Field(
    ...
    def validate_cnpj_format(cls, v):
        ...
        if not v:
            return v
        from app.shared.utils.validators import sanitize_cnpj, validate_cnpj
    ...
    def validate_zip_code_format(cls, v):
        ...
        if not v:
            return v
        from app.shared.utils.validators import validate_cep
    ...
    def validate_coordinates(self):
        ...
        if lat is not None and lng is not None:
            from app.shared.utils.validators import validate_coordinates
