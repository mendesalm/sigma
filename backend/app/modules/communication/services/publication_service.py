...
from app.modules.communication.schemas.publication_schemas import PublicationCreate
from models.models import Publication, PublicationStatusEnum
...
class PublicationService:
    ...
    def create_publication(
        db: Session, publication_data: PublicationCreate, file: UploadFile, author_id: int, lodge_id: int
    ) -> Publication:
        # Validate File
