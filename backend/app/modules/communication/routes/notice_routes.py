...
from app.modules.communication.schemas.notice_schemas import NoticeCreate, NoticeResponse, NoticeUpdate
from app.modules.communication.services.notice_service import NoticeService
...
def check_write_permission(context: UserContext, lodge_id: int):
    ...
    if context.user_type == "member":
        ...
        user_roles = [
            rh.role.name for rh in context.user.role_history if rh.lodge_id == lodge_id and rh.end_date is None
        ]
