...
class IdentificacaoConfig(BaseModel):
    ...
    text_template: str | None = Field(
        default=None, description="Template do identificador. Ex: 'PRANCHA Nº {{ numero_documento }}'"
    )
...
class EnderecamentoConfig(BaseModel):
    ...
    # Template de texto (HTML/Jinja2)
    text_template: str | None = Field(
        default=None, description="Template do endereçamento. Ex: 'Ao Ill∴ Ir∴ {{ destinatario }}'"
    )
...
class AssuntoConfig(BaseModel):
    ...
    # Template de texto (HTML/Jinja2)
    text_template: str | None = Field(default=None, description="Template do assunto. Ex: '{{ assunto_texto }}'")
...
class TextoConfig(BaseModel):
    ...
    # Template de texto (HTML/Jinja2)
    text_template: str | None = Field(default=None, description="Template do corpo do texto com variáveis Jinja2")
...
class LocalDataConfig(BaseModel):
    ...
    # Template de texto (HTML/Jinja2)
    text_template: str | None = Field(default=None, description="Template da linha de local e data")
...
class SignaturesConfig(BaseModel):
    ...
    # Template de texto (HTML/Jinja2)
    text_template: str | None = Field(default=None, description="Template HTML das assinaturas")
...
class FooterConfig(BaseModel):
    ...
    # Template de texto (HTML/Jinja2)
    text_template: str | None = Field(default=None, description="Template HTML do rodapé")
...
class StructuralElement(BaseModel):
    ...
    key: str = Field(
        description="Chave do elemento: cabecalho_pagina, titulos, identificacao, enderecamento, assunto, texto, local_data, assinatura, rodape_pagina"
    )
...
class DocumentTypeSettings(BaseModel):
    ...
    structural_elements: list[StructuralElement] | None = Field(
        default=None, description="Elementos estruturais escolhidos e sua ordem de composição"
    )
