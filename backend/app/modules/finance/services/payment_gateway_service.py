...
from app.modules.finance.schemas.financial_transaction_schema import GatewayProvider
...
def generate_payment_link(
    ...
    return {"gateway_id": None, "gateway_link": None, "gateway_barcode": None, "gateway_pix_qrcode": None}
