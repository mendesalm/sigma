...
class TestCNPJValidation:
    ...
    def test_invalid_cnpj_wrong_check_digits(self):
        ...
        assert not validate_cnpj("11.222.333/0001-00")

    def test_invalid_cnpj_wrong_length(self):
        """CNPJ com tamanho incorreto deve falhar."""
        assert not validate_cnpj("11.222.333")
...
class TestPhoneValidation:
    ...
    def test_valid_cellphone(self):
        ...
        valid_phones = ["(61) 99999-9999", "(11) 98765-4321", "61999999999", "(61)99999-9999"]
...
class TestCoordinatesValidation:
    ...
    def test_valid_coordinates(self):
        ...
        assert validate_coordinates(-15.7942, -47.8822)  # Brasília
...
class TestCIMValidation:
    ...
    def test_valid_cim(self):
        ...
        assert validate_cim("272875")
        assert validate_cim("1234")
        assert validate_cim("12345678901234567890")  # 20 dígitos

    def test_invalid_cim_too_short(self):
        """CIM muito curto deve falhar."""
        assert not validate_cim("123")
        assert not validate_cim("12")

    def test_invalid_cim_too_long(self):
        """CIM muito longo deve falhar."""
        assert not validate_cim("123456789012345678901")  # 21 dígitos

    def test_invalid_cim_non_numeric(self):
        """CIM não numérico deve falhar."""
        assert not validate_cim("ABC123")
        assert not validate_cim("12-34")
        assert not validate_cim("")
