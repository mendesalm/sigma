...
class Obedience(BaseModel):
    ...
    tax_id = Column(String(18), unique=True, nullable=True)
    ...
    technical_contact_name = Column(String(255), nullable=True)
...
class Lodge(BaseModel):
    ...
    rite = Column(String(50), nullable=True)
    obedience_id = Column(Integer, ForeignKey('obediences.id'), nullable=False)
    obedience_name = Column(String(255))
    tax_id = Column(String(18), unique=True, nullable=True)
    email = Column(String(255), nullable=True)
    phone = Column(String(20), nullable=True)
    website = Column(String(255), nullable=True)
