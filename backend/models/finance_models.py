...
class LodgeFinancialConfig(Base):
    ...
    )  # Preferably encrypted/vaulted in real life, but for now String
    ...
    recalculate_late_fees = Column(
        Boolean, default=True
    )  # Se True, juros e multas entram no mesmo lançamento original, senao requer nova transacao
