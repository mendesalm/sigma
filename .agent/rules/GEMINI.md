...
### ?? Configura��es Default de M�dulos (Global Mandatory)
- **Regra**: Todos os m�dulos e recursos opcionais do sistema (ex: notifica��es de whatsapp whatsapp_notifications_enabled, chancelaria extra, etc) devem ter uma flag is_active ou similar associada e vir desativados (False) por default na modelagem (banco de dados/Alembic) e nos Schemas.
