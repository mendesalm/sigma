                ...
                <Grid container spacing={2}>
                  ...
                  <Grid
                    size={{
                      xs: 12,
                      md: 6
                    }}><TextField label="Nacionalidade" name="nationality" value={formState.nationality} onChange={handleChange} fullWidth sx={customTextFieldStyle} InputLabelProps={{ shrink: true }} /></Grid>
                  <Grid
                    size={{
                      xs: 12,
                      md: 6
                  ...
                  <Grid
                    size={{
                      xs: 12
                    }}><TextField label="Religião / Crença" name="religion" value={formState.religion} onChange={handleChange} fullWidth sx={customTextFieldStyle} InputLabelProps={{ shrink: true }} /></Grid>
                </Grid>
              </CardContent>
            </Card>
          </Grid>
            ...
            <Grid container spacing={2}>
              ...
              <Grid
                size={{
                  xs: 12,
                  md: 12
                }}><TextField label="Cidade / UF" name="city" value={formState.city} onChange={handleChange} fullWidth sx={customTextFieldStyle} InputLabelProps={{ shrink: true }} /></Grid>
            </Grid>
          </CardContent>
        </Card>
      </TabPanel>
                  ...
                  <Paper sx={{ p: 2, bgcolor: COLORS.background, border: '1px solid rgba(255,255,255,0.1)' }}>
                    ...
                    <Grid container spacing={2}>
                      <Grid
                        size={{
                          xs: 8
                        }}><TextField label="Nome" value={member.full_name} onChange={(e) => handleFamilyMemberChange(index, 'full_name', e.target.value)} fullWidth size="small" sx={customTextFieldStyle} InputLabelProps={{ shrink: true }} /></Grid>
                      <Grid
                        size={{
                          xs: 4
                        }}>
                      ...
                      <Grid
                        size={{
                          xs: 4
                        }}><TextField label="Nascimento" type="date" value={member.birth_date} onChange={(e) => handleFamilyMemberChange(index, 'birth_date', e.target.value)} fullWidth size="small" sx={customTextFieldStyle} InputLabelProps={{ shrink: true }} /></Grid>
                      <Grid
                        size={{
                          xs: 8
                        }}><TextField label="Telefone" value={member.phone} onChange={(e) => handleFamilyMemberChange(index, 'phone', e.target.value)} fullWidth size="small" sx={customTextFieldStyle} InputLabelProps={{ shrink: true }} /></Grid>
                    </Grid>
                  </Paper>
                </Grid>
              ))}
            ...
            <Grid container spacing={2}>
              <Grid
                size={{
                  xs: 12,
                  md: 6
                }}><TextField label="Formação Acadêmica" name="education_level" value={formState.education_level} onChange={handleChange} fullWidth sx={customTextFieldStyle} InputLabelProps={{ shrink: true }} /></Grid>
              <Grid
                size={{
                  xs: 12,
                  md: 6
              ...
              <Grid
                size={{
                  xs: 12
                }}><TextField label="Local de Trabalho" name="workplace" value={formState.workplace} onChange={handleChange} fullWidth sx={customTextFieldStyle} InputLabelProps={{ shrink: true }} /></Grid>
            </Grid>
          </CardContent>
        </Card>
      </TabPanel>
